...
model: sonnet
tier: standard
skills: [setup-gbrain, sync-gbrain, gstack-upgrade, onboard, health, find-skills, write-a-skill, skillify, context-save, context-restore, onboard-project, evolve-memory, harness-audit, capture, calibrate]
aliases: []
tools:
  write: true
  edit: true
