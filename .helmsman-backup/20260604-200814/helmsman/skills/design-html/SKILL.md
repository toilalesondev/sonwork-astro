...
description: >-
  ...
  mockup", typically after design-shotgun, design-consultation, or a plan-review.
---
...
- Usually follows `design-shotgun` (chosen variant), `design-consultation` (system), or a `plan-review`.
