...
description: >-
  ...
  DX / DX audit / try the onboarding" for a developer-facing product. (Plan-stage DX → plan-review --lens devex.)
---
...
present). The plan-stage version is `plan-review --lens devex`; this audits the shipped experience.
...
5. **Scorecard** — rate the DX dimensions with evidence; compare against `plan-review --lens devex`
