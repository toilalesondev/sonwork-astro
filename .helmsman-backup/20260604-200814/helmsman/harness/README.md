...
| `skill-standard.md` | **What "a Helmsman skill" is** — the canonical frontmatter + section shape every first-party skill conforms to. Owned, not borrowed; privatization + `ingest-skill` conform to it; `harness-audit` enforces the mechanical floor. |
