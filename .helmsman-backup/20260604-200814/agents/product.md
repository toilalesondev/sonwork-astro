...
tier: standard
evolver_tier: light
skills: [office-hours, design-shotgun, design-consultation, to-prd, plan-review, autoplan]
aliases: [gstack]
tools:
  write: true
  edit: true
...
- `plan-review` — CEO-lens scope review: expand / hold / reduce (lens: ceo)
- `autoplan` — run all plan-review lenses sequentially, auto-decide, gate the taste calls
