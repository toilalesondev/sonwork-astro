...
tier: light
evolver_tier: light
skills: [office-hours, document-generate, handoff, watzup, scrape, monitor]
aliases: []
tools:
  write: true
  edit: true
...
- `monitor` — measure + compare performance numbers (perf mode) / cross-model benchmark (models mode).
