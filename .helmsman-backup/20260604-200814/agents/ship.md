...
tier: standard
evolver_tier: light
skills: [ship, land-and-deploy, code-review, claude, qa, browse, scrape, investigate, monitor, health, retro, document-release, landing-report, verify]
aliases: [gstack]
tools:
  write: true
  edit: true
...
**Monitor**
- `monitor` — post-deploy + perf watching. Modes: **canary** (watch live prod), **perf**
  (page-speed/web-vitals vs baseline), **models** (cross-model benchmark).
