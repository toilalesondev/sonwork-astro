...
tier: standard
evolver_tier: light
skills: [tdd, diagnose, improve-codebase-architecture, grill, to-prd, to-issues, triage, prototype, plan-review, generate-plan, challenge, verify, code-review, autoresearch]
aliases: [matt]
tools:
  write: true
  edit: true
...
- `grill` — stress-test a plan/design before building (docs mode checks it against the domain model + ADRs).
...
- `plan-review` — lock in architecture/data-flow/edge-cases before coding (lens: eng).
