...
tier: standard
evolver_tier: light
skills: [cso, setup-deploy, devex-review, plan-devex-review, document-generate, generate-plan, challenge, verify, code-review, autoresearch]
aliases: []
tools:
  write: true
  edit: true
...
- `devex-review` — audit live API/SDK/CLI developer experience. `plan-devex-review` — plan-stage DX review.
