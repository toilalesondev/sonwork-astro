...
Understand what's being designed and the constraints. Recall prior taste signals (what the user
liked/rejected before) so variants don't repeat rejected directions.
