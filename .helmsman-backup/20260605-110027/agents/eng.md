...
tier: standard
evolver_tier: light
skills: [tdd, diagnose, improve-codebase-architecture, grill, to-prd, to-issues, triage, prototype, plan-eng-review, generate-plan, challenge, verify, code-review, autoresearch]
aliases: [matt]
tools:
  write: true
  edit: true
