...
tier: standard
evolver_tier: light
skills: [setup-gbrain, brain-sync, gbrain-upgrade, gstack-upgrade, health, privatize, skill-stocktake, context, onboard-project, evolve-memory, harness-audit, capture, calibrate, adherence-check]
aliases: []
tools:
  write: true
  edit: true
