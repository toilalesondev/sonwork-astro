...
- `gbrain-upgrade` — upgrade the gbrain binary/tooling. `gstack-upgrade` — upgrade gstack tooling.
- `onboard` / `onboard-project` — scaffold a project into the harness (first-touch setup).
- `find-skills` / `write-a-skill` / `skillify` — discover / author / codify skills.
