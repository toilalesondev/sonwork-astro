...
tier: standard
evolver_tier: light
skills: [setup-gbrain, sync-gbrain, gstack-upgrade, onboard, health, find-skills, write-a-skill, skillify, context-save, context-restore, onboard-project, evolve-memory, harness-audit, capture, calibrate, adherence-check]
aliases: []
tools:
  write: true
  edit: true
