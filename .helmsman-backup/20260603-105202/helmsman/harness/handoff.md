...
### EXPLORE → PLAN
@scout/@brain finish with `DONE` and **write their facts into the plan stub** (file:line,
...
### WRITE-BACK → memory
@brain returns a numbered proposal (the packet); **✋ human gate**; on approval @brain
